...
$pageDescription = 'Aradiginiz sayfa bulunamadi.';
...
<section class="py-20 bg-gray-50 min-h-[60vh] flex items-center">
    <div class="container">
        <div class="text-center max-w-lg mx-auto">
            ...
            <h1 class="text-3xl font-bold text-primary mb-4">Sayfa Bulunamadi</h1>
            <p class="text-gray-600 mb-8">Aradiginiz sayfa mevcut degil veya tasinmis olabilir.</p>
